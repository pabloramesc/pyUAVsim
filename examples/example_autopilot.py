...
from simulator.autopilot import Autopilot, LinePathFollower, OrbitPathFollower
...
line_follower = LinePathFollower(autopilot.config)
line_follower.set_path(np.array([0, 500, -1e3]), np.array([1, 0, -0.2]))
orbit_follower = OrbitPathFollower(autopilot.config)
...
while True:
    ...
    X_cmd, h_cmd = orbit_follower.guidance(
